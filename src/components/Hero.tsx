...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background pt-20">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-primary/10 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: "1s" }} />
      ...
      <div className="container mx-auto px-4 text-center max-w-4xl relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20 animate-fade-in" style={{ animationDelay: "0.3s" }}>
          <Button 
            size="lg" 
            className="text-base glow hover-lift"
            asChild
          >
            <a 
        ...
        <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto pt-12 border-t border-primary/20 animate-fade-in" style={{ animationDelay: "0.4s" }}>
          {[
